...
const SearchArtworks = ({
  ...
  const ListView = forwardRef((props, ref) => {
    ...
    const artworkChunks = chunkData(artworkData, 10); // Split the artworkData into chunks of 10

    const columnStyles = [
      { backgroundColor: "#8dd3c7", label: "Europeana" }, // AliceBlue
      { backgroundColor: "#ffffb3", label: "University Library" }, // WhiteSmoke
      { backgroundColor: "#bebada", label: "Wikipedia" }, // LightGoldenRodYellow
    ];
      ...
      <Container>
        <Row>
          {showProgressbar ? (
            ...
            artworkChunks.map((chunk, columnIndex) => (
              <Col
                key={columnIndex}
                xs={12}
                md={4}
                style={{
                  backgroundColor: columnStyles[columnIndex]?.backgroundColor,
                  paddingRight: "3rem",
                }}
              >
                <h5 style={{ textAlign: "center", paddingTop: "1rem" }}>
                  {columnStyles[columnIndex]?.label}
                </h5>
                {chunk.map((artwork, index) => (
                  <Card key={index} className="artwork-card mb-4">
                    <Row
                      onClick={(event) =>
                      ...
                      <Col xs={7}>
                        <Card.Body>
                          ...
                          >
                            ...
                            {/* <CardLogo 
                            src={artwork.license === "EXLIB" ? "./uofrLogo.png" : "./europeana.png"} 
                            alt="Artwork Logo" 
                          /> */}
                            <CardLogo
                              src={
