...
const getUserLikedArtworks = async function () {
    ...
    const response = await fetch(mainURL + 'getLikedArtworksForUser', requestOptions).then(function (response) {
        if (!response.ok) {
...
export default getUserLikedArtworks;
