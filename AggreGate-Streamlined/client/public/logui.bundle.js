...
let configurationObject = {
    ...
    logUIConfiguration: {
        ...
        endpoint: 'ws://localhost:2007/ws/',
        //endpoint: 'ws://ec2-3-143-18-63.us-east-2.compute.amazonaws.com:2007/ws/',
    ...
    applicationSpecificData: {
        ...
        interface: "serp-focused-interface"
    },
    trackingConfiguration: {
        ...
        'copy-right-icon-clicked': {
            selector: '.copy-right-icon',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-copy-right-icon',
                },
            },
            metadata: [
                {
        ...
        'license-icon-clicked': {
            selector: '.license-icon',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-license-icon',
                },
            },
            metadata: [
                {
        ...
        }, 'grid-mosaic-view-clicked': {
            selector: '.icon-group',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-grid-mosaic-view-icon',
                },
            },
            metadata: [
                {
        ...
        }, 'europeana-icon-clicked': {
            selector: '#europeanaIcon',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-europeana-icon',
                },
            },
            metadata: [
                {
        ...
        }, 'keyword-disc-clicked': {
            selector: '.keyword-disc',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-keyword',
                },
            },
            metadata: [
                {
        ...
        'show-adavanced-filters-clicked': {
            selector: '.show-adavanced-filters',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-show-adavanced-filters',
                },
            },
            metadata: [
                {
        ...
        },'navbarElement-clicked': {
            selector: '.navbarElement',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-navbarElement',
                },
            },
            metadata: [
                {
        ...
        },'artwork-card-grid-clicked': {
            selector: '.artwork-card-grid',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-collection',
                },
            },
            metadata: [
                {
        ...
        },'card-image-grid-clicked': {
            selector: '.artwork-card-grid',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-create-new-gallery',
                },
            },
            metadata: [
                {
        ...
        },'gallery-keyword-clicked': {
            selector: '.gallery-keyword',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-keyword',
                },
            },
            metadata: [
                {
        ...
        },'gallery-edit-btn-clicked': {
            selector: '.gallery-edit-btn',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-edit-btn',
                },
            },
            metadata: [
                {
        ...
        },'gallery-delete-btn-clicked': {
            selector: '.gallery-delete-btn',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-delete-btn',
                },
            },
            metadata: [
                {
        ...
        },'gallery-update-btn-clicked': {
            selector: '.gallery-update-btn',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-update-btn',
                },
            },
            metadata: [
                {
        ...
        },'gallery-create-btn-clicked': {
            selector: '.gallery-create-btn',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-create-btn',
                },
            },
            metadata: [
                {
        ...
        },'gallery-add-btn-clicked': {
            selector: '.gallery-add-btn',
            event: 'mouseClick',
            properties: {
                primary: {
                    name: 'clicked-on-gallery-add-btn',
                },
            },
            metadata: [
                {
